...
class IngredientSpecificationController extends Controller
{
    public function index()
    {
        ...
        return view('ingredient_specifications.index', compact('ingredientSpecifications'));
    }
    ...
    public function create()
    {
        ...
        return view('ingredient_specifications.create', compact(
            'ingredients',
            'suppliers',
            'nutritionProfiles',
            'units'
    ...
    public function edit(IngredientSpecification $ingredientSpecification)
    {
        ...
        return view('ingredient_specifications.edit', compact(
    ...
    public function update(Request $request, IngredientSpecification $ingredientSpecification)
    {
        $validated = $request->validate([
            'ingredient_id' => ['required', 'exists:ingredients,id'],
            'supplier_id' => ['required', 'exists:suppliers,id'],
